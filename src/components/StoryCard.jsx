...
const StoryCard = () => {
  ...
  const text = `  Bismillah, perjalanan kami menjalani ibadah terpanjang dalam hidup baru saja akan dimulai. Semoga dengan niat yang baik dan ikhlas, segala sesuatunya dapat berjalan dengan lancar. Kami memohon doa restu dari keluarga, sahabat, rekan-rekan, semoga ini dapat menjadi awal lembaran baru yang penuh berkah serta dapat menjadi keluarga yang sakinah mawaddah warahmah sampai jannah-Nya Allah. Aamiin.\n\nFebri dan Arman`;
  ...
  useEffect(() => {
    ...
    }, 220); // ketik per 35ms (bisa disesuaikan kecepatannya)
